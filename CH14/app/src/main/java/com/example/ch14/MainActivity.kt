...
class MainActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onRequestPermissionsResult(requestCode: Int,
        ...
        //super.onRequestPermissionsResult(requestCode, permissions, grantResults)  //這行到底要不要加呢?
    ...
    private fun loadMap() {
        val map = supportFragmentManager.findFragmentById(R.id.map) //連接SupportMapFragment載入地圖
